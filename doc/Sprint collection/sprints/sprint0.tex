...
\resulttable
{
	\addresult{DONE, but no feedback was recieved from supervisor.}{EF}
	\addresult{DONE, but no feedback was recieved from supervisor.}{GH, MR}
	\addresult{DONE, but no feedback was recieved from supervisor.}{MT, NW}
	\addresult{DONE, resulted in a new backlog item (1).}{MS}
	\addresult{DONE, but FoV was too narrow using the USB camera.}{MR, AS}
	\addresult{DONE, CAVIAR GUI is used for labeling.}{EF, MR, AS}
	\addresult{DONE, resulted in two new backlog items (2 and 3).}{MT, NW}
	\addresult{DONE.}{GH}
	\addresult{DONE, see the project wiki page at github.}{MT, MS}
	\addresult{DONE, see the project wiki page at github.}{GH, MS}
	\addresult{DONE, however a full system test is not complete as this item was only regarding the framework.}{GH, NW}
	\addresult{DONE.}{AS, MS}
	\addresult{DONE.}{MS}
...
Adding a template for the review collection, which is a collection of these documents, one for every sprint that are to be submitted at the end of the course.
