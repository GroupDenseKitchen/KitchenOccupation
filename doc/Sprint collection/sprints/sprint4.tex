...
\resulttable
{
	...
	\addresult{Create figures for the report/DOxygen code reference manual. E.g. intermadiate algorithm steps and a nice visualization of system performance.}{\textbf{Everyone}}
	\addresult{Done, three new data sets of various quality have been recorded.}{\textbf{Everyone}}
	\addresult{In pogress: Write a system overview for the webpage and DOxygen manual.}{\textbf{Everyone}}
	\addresult{In progress: Perform a complete system test on both platforms, running both live and from file.}{\textbf{Everyone}}
	\addresult{Not done. Create a manual for the debug GUI.}{\textbf{Everyone}}
	\addresult{Not done. Create a manual for the installation procedure.}{\textbf{Everyone}}
	\addresult{Discarded, things work just fine. Revise the requirement on multiple kinects.}{\textbf{Everyone}}
	\addresult{Not done. Add content to the web page.}{\textbf{Everyone}}
	\addresult{In progress: Create a non-GUI version of the program.}{\textbf{GH}}
	\addresult{Done: Improve the presentation of evaluation performance.}{\textbf{Everyone}}
	\addresult{In progress: Send info about the number of people in the room over the network.}{\textbf{Everyone}}
	\addresult{Done: Finalize queue detection.}{\textbf{Everyone}}
	\addresult{Done: Put together queue information over time.}{\textbf{Everyone}}
	\addresult{Done: Investigate the situation in the demo room.}{\textbf{Everyone}}
	\addresult{Done: Make the kinect run live on OS X.}{\textbf{Everyone}}
	\addresult{Done: Make the kinect run live on Windows.}{\textbf{Everyone}}
	\addresult{-Ish Make the system more robust vs different sensor placements.}{\textbf{Everyone}}
