...
The performance of the training data set is very good. This is a sequence of 30 minutes, where only the first 5  was used in development. Evaluation data 1 performed worse, which can be explained by that the camera of this sequence was placed badly and didn't cover the entry area completely. 
