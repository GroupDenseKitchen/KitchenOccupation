...
\begin{subfigure}{.5\textwidth}
  ...
  \label{fig:sub2}
\end{subfigure}
\caption[Entries training]{\textit{R-Kitchen data. Plot of measured entries, ground truth and accuracy}}
...
\begin{subfigure}{.5\textwidth}
  ...
  \label{fig:sub2}
\end{subfigure}
\caption[Entries training]{\textit{R-Kitchen data. Plot of measured exits, ground truth and accuracy}}
