...
\begin{figure}[htb]
	...
	\caption[Overview of the entire system]{\textit{System overview. One Microsoft Kinect (green objects) is placed over each entry to the room (doors). The Kinects are connected to a computation device, which communicates to a server over the internet.}}
