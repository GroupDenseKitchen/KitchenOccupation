...
\begin{itemize}
\item{The tracker pairs objects with each other from previous frame to the current frame. Pairs closest matching objects, includes error handling.}
\item{Counting is done using checkpoint lines and a door area.}
\end{itemize}
