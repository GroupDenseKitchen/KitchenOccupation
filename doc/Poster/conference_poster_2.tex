...
\caption{\centering \textit{Figure 7:} Main GUI window with the different processing steps (top left), profiling information for system modules (top right) and log messages (bottom)}
\end{figure}
