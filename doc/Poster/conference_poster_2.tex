...
\begin{itemize}
	...
	\begin{itemize}
		\item Queues are detected using Bézier curves using object velocities.
		\item Queue severity is calculated averaging detected queues over a few frames
	\end{itemize}
\end{itemize}
