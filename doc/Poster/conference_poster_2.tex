...
\begin{column}{0.45\textwidth}
\begin{figure}
\includegraphics[width=1\linewidth]{trackingExample.png}
\caption{Newly found potential objects(red), lost object(blue) and an object(green)}
\end{figure}
\end{column}
\end{columns}
...
\begin{column}{0.45\textwidth}
\begin{figure}
\includegraphics[width=1\linewidth]{visibleQueue.png}
\caption{Figure caption}
\end{figure}
\end{column}
\end{columns}
