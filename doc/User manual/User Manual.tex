...
\begin{tabular}{|p{1cm}|p{2.0cm}|p{5cm}|p{1.5cm}|p{2cm}|}
	...
	\hline
	1.0 & 2013--12--13 & Initial draft & MS & MT\\
	
	\hline
	1.1 & 2013--12--20 & Figure and identity update & AS & MR\\
...
\input{text_files/systemInstallation.tex}
\newpage

\section{Setting up the system}
The easiest way to setup the system is by using the GUI. Here the main settings can be adjusted. However, there are some advanced settings that can only be adjusted in the configuration file. More on this in section \ref{sec:ConfigurationFile}. 

\subsection{Calibration}
\label{sec:setup}
\input{text_files/systemCalibration.tex}
\newpage
\subsection{Configuration}
\label{sec:configuration}
\input{text_files/systemConfiguration.tex}
\newpage

\subsection{Debugging from GUI}
\label{sec:GUI}
\input{text_files/running_system.tex}
\newpage
