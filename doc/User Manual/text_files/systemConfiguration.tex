...
To add an exclusion mask press New Polygon. Now a draw the mask by clicking in the image which adds control points to the mask. To undo press Ctrl + Z. When the mask is done press Add as exclusion.
