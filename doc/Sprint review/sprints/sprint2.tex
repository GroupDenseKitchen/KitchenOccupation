...
\resulttable
{
	...
	\addresult{Done.}{hours}{Involved members}
	\addresult{Not finalized, more discussions}{hours}{Involved members}
	\addresult{Not done.}{hours}{Involved members}
	\addresult{Done.}{hours}{Involved members}
	\addresult{Not done.}{hours}{Involved members}
	\addresult{Not done. Labeling program is complete, but integration of the evaluation is not complete.}{hours}{Involved members}
	\addresult{Done.}{hours}{Involved members}	

}

\subsection{New Backlog Items}
Several new backlog items were created as a result of this sprint, all of them consist of unifinished items that are carried over directly to the next sprint.
