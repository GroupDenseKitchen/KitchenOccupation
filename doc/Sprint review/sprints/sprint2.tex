...
\resulttable
{
	\addresult{Done, but an overview image is missing.}{--}{Involved members}
	\addresult{Done.}{--}{Involved members}
	\addresult{Done, but better data need to be gathered as the current data set is out of focus at head level.)}{--}{Involved members}
	\addresult{Done. (in/out fow is estimated.)}{--}{Involved members}
	\addresult{Done. Exposure time is now constant and 50Hz noise is removed.}{--}{Involved members}
	\addresult{Done, with a naive implementation that should be improved once the segmentation improves.}{--}{Involved members}
	\addresult{Developed, however it is untuned, untested and not inserted into the system, as better tracking/segmentation is required to test this properly.}{--}{Involved members}
	\addresult{Done. Papers seem very useful, and have been studied.}{--}{Involved members}
	\addresult{Not done, the OpenCV function does not perform good enough.}{--}{Involved members}
	\addresult{Slightly better but not good enough to work alone, and will probably have to be combined with some form of human detector.}{--}{Involved members}
	\addresult{Not done. Partially due to the same reason as above item.}{--}{Involved members}
	\addresult{Done.}{--}{Involved members}
	\addresult{Not finalized, more discussions}{--}{Involved members}
	\addresult{Not done.}{--}{Involved members}
	\addresult{Done.}{--}{Involved members}
	\addresult{Not done.}{--}{Involved members}
	\addresult{Not done. Labeling program is complete, but integration of the evaluation is not complete.}{--}{Involved members}
	\addresult{Done.}{--}{Involved members}	
