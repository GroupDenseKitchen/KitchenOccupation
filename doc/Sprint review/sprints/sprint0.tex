...
Adding a template for the reciew collection, which is a collection of these documents, one for every sprint that are to be submitted at the end of the course.

\subsubsection{New backlog Item 2}
The algotirh interface in the image processing and the content of the FrameList class.
